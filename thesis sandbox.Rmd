...
# check the number of republican and democrat nodes
print(sum(V(net_clicknov20)$party == "Democrat"))
```
...
modularity_scores <- data.frame(
  Month = c("November '19", "December '19", "January '20", "February '20", "March '20", "April '20", "May '20", "June '20", "July '20", "August '20", "September '20", "October '20", "November '20", "December '20", "January '21", "February '21", "March '21", "April '21", "May '21", "June '21", "July '21", "August '21", "September '21", "November '21"),
  Modularity = c(
    communities_nov19, communities_dec19, communities_jan20, communities_feb20, communities_mar20, communities_apr20, communities_may20, communities_jun20, communities_jul20, communities_aug20, communities_sep20, communities_oct20, communities_nov20, communities_dec20, communities_jan21, communities_feb21, communities_mar21, communities_apr21, communities_may21, communities_jun21, communities_jul21, communities_aug21, communities_sep21, communities_nov21))
...
exposure_data <- data.frame(
  month = c("October 2020", "November 2020", "December 2020", "January 2021", "February 2021"),
  democrat = c(exposure_dem_oct20, exposure_dem_nov20, exposure_dem_dec20, exposure_dem_jan21, exposure_dem_feb21),
  republican = c(exposure_rep_oct20, exposure_rep_nov20, exposure_rep_dec20, exposure_rep_jan21, exposure_rep_feb21)
)

# factorise month 
exposure_data$month <- factor(exposure_data$month, levels = c("October 2020", "November 2020", "December 2020", "January 2021", "February 2021"))
...
ggplot(exposure_data_long, aes(x = month, y = value, fill = variable)) +
  geom_bar(stat = "identity", position = "dodge") +
  labs(title = "Exposure to Diverse Information by Party",
       x = "Month",
...
exposure_df <- bind_rows(
  data.frame(month = "October 2020", party = "Democrat", exposure = exposure_percentages_oct$democrat),
  data.frame(month = "October 2020", party = "Republican", exposure = exposure_percentages_oct$republican),
  data.frame(month = "November 2020", party = "Democrat", exposure = exposure_percentages_nov$democrat),
  data.frame(month = "November 2020", party = "Republican", exposure = exposure_percentages_nov$republican),
  data.frame(month = "December 2020", party = "Democrat", exposure = exposure_percentages_dec$democrat),
  data.frame(month = "December 2020", party = "Republican", exposure = exposure_percentages_dec$republican),
  data.frame(month = "January 2021", party = "Democrat", exposure = exposure_percentages_jan$democrat),
  data.frame(month = "January 2021", party = "Republican", exposure = exposure_percentages_jan$republican),
  data.frame(month = "February 2021", party = "Democrat", exposure = exposure_percentages_feb$democrat),
  data.frame(month = "February 2021", party = "Republican", exposure = exposure_percentages_feb$republican)
)

# factorise month
exposure_df$month <- factor(exposure_df$month, levels = c("October 2020", "November 2020", "December 2020", "January 2021", "February 2021"))


add_steps <- function(df) {
  steps <- rep(1:5, each = length(df$exposure) / 5)
  df$steps <- steps
  return(df)
}

# Apply the function to add steps
exposure_df <- exposure_df %>%
  group_by(month, party) %>%
  do(add_steps(.))

# Plot the data using ggplot2
ggplot(exposure_df, aes(x = steps, y = exposure, color = month, linetype = party, group = interaction(month, party))) +
  geom_line() +
  geom_point() +
  labs(
    title = "Exposure to Diverse Information Over Steps",
    x = "Steps",
    y = "Exposure to Other Partition (%)"
  ) +
  theme_minimal() +
...
exposure_random_data <- data.frame(
  month = c("October 2020", "November 2020", "December 2020", "January 2021", "February 2021"),
  democrat = c(exposure_random_oct20, exposure_random_nov20, exposure_random_dec20, exposure_random_jan21, exposure_random_feb21),
  republican = c(exposure_random_oct20_rep, exposure_random_nov20_rep, exposure_random_dec20_rep, exposure_random_jan21_rep, exposure_random_feb21_rep)
)


# factorise month
exposure_random_data$month <- factor(exposure_random_data$month, levels = c("October 2020", "November 2020", "December 2020", "January 2021", "February 2021"))
...
exposure_random_df <- bind_rows(
  data.frame(month = "October 2020", party = "Democrat", exposure = exposure_percentages_random_oct$democrat),
  data.frame(month = "November 2020", party = "Democrat", exposure = exposure_percentages_random_nov$democrat),
  data.frame(month = "November 2020", party = "Republican", exposure = exposure_percentages_random_nov$republican),
  data.frame(month = "December 2020", party = "Democrat", exposure = exposure_percentages_random_dec$democrat),
  data.frame(month = "December 2020", party = "Republican", exposure = exposure_percentages_random_dec$republican),
  data.frame(month = "January 2021", party = "Democrat", exposure = exposure_percentages_random_jan$democrat),
  data.frame(month = "January 2021", party = "Republican", exposure = exposure_percentages_random_jan$republican),
  data.frame(month = "February 2021", party = "Democrat", exposure = exposure_percentages_random_feb$democrat),
  data.frame(month = "February 2021", party = "Republican", exposure = exposure_percentages_random_feb$republican)
)

# factorise month
exposure_random_df$month <- factor(exposure_random_df$month, levels = c("October 2020", "November 2020", "December 2020", "January 2021", "February 2021"))

# Apply the function to add steps
exposure_random_df <- exposure_random_df %>%
  group_by(month, party) %>%
  do(add_steps(.))

# Plot the data using ggplot2
ggplot(exposure_random_df, aes(x = steps, y = exposure, color = party, linetype = month, group = interaction(month, party))) +
  geom_line() +
  geom_point() +
  labs(
    title = "Exposure to Diverse Information Over Steps in Random Networks",
    x = "Steps",
    y = "Exposure to Other Partition (%)"
  ) +
  theme_minimal() +
