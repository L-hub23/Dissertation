...
```{r}
# save RData image
save.image("data/click_networks2.RData")
load("data/click_networks2.RData")
```
...
new_affiliations <- rbind(new_affiliations, data.frame(Element = c("call_of_duty:_black_ops_cold_war", "borat_subsequent_moviefilm", "joe_exotic", "stephen_colbert", "billie_eilish", "ken_burns", "tom_brady"), Category = "Other"))
...
results_rep_aug20 <- analyze_party_walk(net_clickaug20, "Republican", iterations = 100, steps = 10)

results_rep_sep20 <- analyze_party_walk(net_clicksep20, "Republican", page_names_republican, steps = 5)

results_rep_oct20 <- analyze_party_walk(net_clickoct20, "Republican", iterations = 100, steps = 10)

results_rep_nov20 <- analyze_party_walk(net_clicknov20, "Republican", page_names_republican, steps = 5)

results_rep_dec20 <- analyze_party_walk(net_clickdec20, "Republican", iterations = 100, steps = 10)
results_rep_jan21 <- analyze_party_walk(net_clickjan21, "Republican", iterations = 100, steps = 10)
results_rep_feb21 <- analyze_party_walk(net_clickfeb21, "Republican", iterations = 100, steps = 10)
results_rep_mar21 <- analyze_party_walk(net_clickmar21, "Republican", iterations = 100, steps = 10)
