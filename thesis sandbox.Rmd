...
new_affiliations <- rbind(new_affiliations, data.frame(Element = c("call_of_duty:_black_ops_cold_war", "borat_subsequent_moviefilm", "joe_exotic", "stephen_colbert", "billie_eilish", "ken_burns", "tom_brady", "john_wane_gacy", "ken_jennings", "beyoncé", "stephen_king", "jennifer_garner", "gilian_anderson"), Category = "Other"))
...
net_clicknov19$party[net_clicknov19$party == "Politics"] <- "Other"
net_clickdec19$party[net_clickdec19$party == "Politics"] <- "Other"
net_clickjan20$party[net_clickjan20$party == "Politics"] <- "Other"
net_clickfeb20$party[net_clickfeb20$party == "Politics"] <- "Other"
net_clickmar20$party[net_clickmar20$party == "Politics"] <- "Other"
net_clickapr20$party[net_clickapr20$party == "Politics"] <- "Other"
net_clickmay20$party[net_clickmay20$party == "Politics"] <- "Other"
net_clickjun20$party[net_clickjun20$party == "Politics"] <- "Other"
net_clickjul20$party[net_clickjul20$party == "Politics"] <- "Other"
net_clickaug20$party[net_clickaug20$party == "Politics"] <- "Other"
net_clicksep20$party[net_clicksep20$party == "Politics"] <- "Other"
net_clickoct20$party[net_clickoct20$party == "Politics"] <- "Other"
net_clicknov20$party[net_clicknov20$party == "Politics"] <- "Other"
net_clickdec20$party[net_clickdec20$party == "Politics"] <- "Other"
net_clickjan21$party[net_clickjan21$party == "Politics"] <- "Other"
net_clickfeb21$party[net_clickfeb21$party == "Politics"] <- "Other"
net_clickmar21$party[net_clickmar21$party == "Politics"] <- "Other"
net_clickapr21$party[net_clickapr21$party == "Politics"] <- "Other"
net_clickmay21$party[net_clickmay21$party == "Politics"] <- "Other"
net_clickjun21$party[net_clickjun21$party == "Politics"] <- "Other"
net_clickjul21$party[net_clickjul21$party == "Politics"] <- "Other"
net_clickaug21$party[net_clickaug21$party == "Politics"] <- "Other"
net_clicksep21$party[net_clicksep21$party == "Politics"] <- "Other"
net_clickoct21$party[net_clickoct21$party == "Politics"] <- "Other"
net_clicknov21$party[net_clicknov21$party == "Politics"] <- "Other"
```
...
page_views_df <- data.frame(
  Page = names(page_views_republican_filtered_jan),
  Views = unlist(page_views_republican_filtered_jan)
)
