...
analyze_party_walk <- function(graph, party, vertices, steps = 10, iterations = 1) {
  ...
  for (iter in 1:iterations) {
    ...
    total_trapped_steps <- c(total_trapped_steps, trapped_steps)
    ...
    total_n_politics <- total_n_politics + n_politics
...
results_nov20_2d <- analyze_party_walk(net_clicknov20, "Democrat", page_names_republican, steps = 5, iterations = 10)

results_nov20_3d <- analyze_party_walk(net_clicknov20, "Democrat", page_names_democrat, steps = 5, iterations = 10)

results_nov20_4d <- analyze_party_walk(net_clicknov20, "Democrat", page_names_republican, steps = 5, iterations = 10)
...
results_nov20_2r <- analyze_party_walk(net_clicknov20, "Republican", page_names_democrat, steps = 5, iterations = 10)

results_nov20_3r <- analyze_party_walk(net_clicknov20, "Republican", page_names_republican, steps = 5, iterations = 10)

results_nov20_4r <- analyze_party_walk(net_clicknov20, "Republican", page_names_democrat, steps = 5, iterations = 10)
