...
# for all of the networks, if the party attribute is "Politics", change it to "Other"
update_party_attribute <- function(network) {
  party_attr <- vertex_attr(network, "party")
  party_attr[party_attr == "Politics"] <- "Other"
  network <- set_vertex_attr(network, "party", value = party_attr)
  return(network)
}

net_clicknov19 <- update_party_attribute(net_clicknov19)
net_clickdec19 <- update_party_attribute(net_clickdec19)
net_clickjan20 <- update_party_attribute(net_clickjan20)
net_clickfeb20 <- update_party_attribute(net_clickfeb20)
net_clickmar20 <- update_party_attribute(net_clickmar20)
net_clickapr20 <- update_party_attribute(net_clickapr20)
net_clickmay20 <- update_party_attribute(net_clickmay20)
net_clickjun20 <- update_party_attribute(net_clickjun20)
net_clickjul20 <- update_party_attribute(net_clickjul20)
net_clickaug20 <- update_party_attribute(net_clickaug20)
net_clicksep20 <- update_party_attribute(net_clicksep20)
net_clickoct20 <- update_party_attribute(net_clickoct20)
net_clicknov20 <- update_party_attribute(net_clicknov20)
net_clickdec20 <- update_party_attribute(net_clickdec20)
net_clickjan21 <- update_party_attribute(net_clickjan21)
net_clickfeb21 <- update_party_attribute(net_clickfeb21)
net_clickmar21 <- update_party_attribute(net_clickmar21)
net_clickapr21 <- update_party_attribute(net_clickapr21)
net_clickmay21 <- update_party_attribute(net_clickmay21)
net_clickjun21 <- update_party_attribute(net_clickjun21)
net_clickjul21 <- update_party_attribute(net_clickjul21)
net_clickaug21 <- update_party_attribute(net_clickaug21)
net_clicksep21 <- update_party_attribute(net_clicksep21)
net_clickoct21 <- update_party_attribute(net_clickoct21)
net_clicknov21 <- update_party_attribute(net_clicknov21)
```
...
# Assuming your data frame is named 'page_views_democrat'
...
results_nov20 <- analyze_party_walk(net_clicknov20, "Democrat", page_names_democrat, steps = 5)

results_dec20 <- analyze_party_walk(net_clickdec20, "Democrat", page_names_democrat_dec, steps = 5)

results_jan21 <- analyze_party_walk(net_clickjan21, "Democrat", page_names_democrat_jan, steps = 5, iterations = 5)
...
results_rep_jan21 <- analyze_party_walk(net_clickjan21, "Republican", page_names_republican_jan, steps = 5, iterations = 5)
...
results_rep_nov$steps <- results_rep_nov$steps / steps_count
```
...
# Map party names to colors
party_colors <- c("Republican" = "red", "Democrat" = "blue", "Other" = "gray")
